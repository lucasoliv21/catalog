    ...
    <div className='h-screen font-inter '>
      <header className='h-9 w-full '>
        <nav className='flex flex-auto justify-between items-center '>
          <a href="" className='px-3 text-xs font-semibold '>Catálogo</a>
          <a href="">
      ...
      <div className='w-full h-20 my-2'>
        ...
        <div className='flex items-center w-40 h-6 ml-4 bg-colorBg border-solid rounded-md border-2 border-gray-400'>
          <input type='text' placeholder="Pesquisar por nome" className='w-32 h-4 px-1 py-2 ml-2 bg-colorBg  text-xs focus:outline-none'/>
          <MagnifyingGlass size={16} color="#9ca3af"/>
        </div>
      </div>

      <div className='grid grid-cols-2 gap-4 '>
        <div className='w-36 h-44 mx-auto text-center border-solid rounded-md border border-zinc-300 flex flex-col justify-items-start items-center'>
          <Image src="/bed.png" width={144} height={96} alt='Foto do produto' />
